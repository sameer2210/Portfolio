...
import { fetchSimpleIcons, ICloud, renderSimpleIcon, SimpleIcon } from 'react-icon-cloud';
    ...
    const loadIcons = async () => {
      try {
        ...
        const slugAliases: Record<string, string> = {
          ...
          radis: 'redis',
          prostgresssql: 'postgresql',
        };

        const updatedSlugs = iconSlugs.map(slug => slugAliases[slug] ?? slug);
